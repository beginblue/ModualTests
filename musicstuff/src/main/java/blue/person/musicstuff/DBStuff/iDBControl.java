...
public interface iDBControl {
     ...
     * @param listName 歌单名称
     */
    void addNewMusicList(String listName);
     ...
     * @param music 要添加的音乐
     */
    void addMusicToList(String listName,Music music);
     ...
     */
    void removeMusicFromList(String listName,String musicName);
     ...
     * @param listName 歌单名称
     */
    void addMusicListToTable(String listName,List<Music> musicList);
