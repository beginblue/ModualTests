...
public class LRCEntity {
    ...
    public static LRCEntity objectFromData(String str) {

        return new Gson().fromJson(str, LRCEntity.class);
    }

    public static List<LRCEntity> arrayLRCEntityFromData(String str) {

        Type listType = new TypeToken<ArrayList<LRCEntity>>() {
        }.getType();
