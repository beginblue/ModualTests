package blue.person.bulumusic.MusicPlayDetailAcitivityStuff.UiStuff;
...
public class LrcView extends View {
     ...
     * @param lrcFile 歌词文件
     */
    public void loadLrc(@Nullable final File lrcFile) {
        reset();
        if (lrcFile == null) {
            mLrcEntryList = new ArrayList<>();
            return;
        }
        setFlag(lrcFile);
     ...
     * @param lrcText 歌词文本
     */
    public void loadLrc(@Nullable final String lrcText) {
        reset();
        if (lrcText == null) {
            mLrcEntryList = new ArrayList<>();
            return;
